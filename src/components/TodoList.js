            ...
            <div className="list-holder">
                ...
                <div className="card">
                    ...
                    <table className='todo-list-holder'>
                        ...
                        <tbody>
                            {todoList.map((todo) => (
                                <tr key={todo.id} onClick={() => goRouteId(todo.id)}>
                                    ...
                                    <td style={{ paddingRight: "10px", width: "10%" }}>
                                        <svg className='edit' width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <svg onClick={() => DeleteTodoHandler(todo.id)} className='delete' width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
